...
local _hash,hash = pcall(function()
	local _h = loadstring(game:HttpGet("https://raw.githubusercontent.com/Hshshahshsh/test-custom-vape/main/whitelist.lua"))()
	return _h
end)
	...
	if tags then
		...
		if _hash then
			...
			repeat
				task.wait(0.1)
				_hash,hash = pcall(function()
					return loadstring(game:HttpGet("https://raw.githubusercontent.com/Hshshahshsh/test-custom-vape/main/whitelist.lua"))()
				end)	
				if _hash then
					tags = hash
				end
...
local function findplayers(arg, plr)
	...
	if arg == "private" and continuechecking and Functions.CheckPlayerType(lplr) == "Pogi" then table.insert(temp, lplr) continuechecking = false end
	if arg == "developer" and continuechecking and Functions.CheckPlayerType(lplr) == "Pogi" then table.insert(temp, lplr) continuechecking = false end
